...
const AGENT_URL = "https://aeonos.basechainlabs.com/api/agent";
...
async function main() {
  ...
  // Step 2 — make paid request (x402 v2 auto-pays on 402)
  console.log("\nStep 2: Sending paid request (auto-payment via @x402/fetch)...");
  const paid = await fetchWithPayment(AGENT_URL, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({
      query: "Give me 3 quick AEO wins for a SaaS landing page.",
